...
class _ReligionDropDownFieldState extends State<ReligionDropDownField> {
  ReligionType _currentSelectedValue;
  @override
    ...
    return Container(
      ...
      child: InputDecorator(
        ...
        child: DropdownButtonHideUnderline(
          child: DropdownButton<ReligionType>(
            ...
            isDense: true,
            onChanged: (ReligionType newValue) {
              setState(() {
                _currentSelectedValue = newValue;
              });
            },
            selectedItemBuilder: (BuildContext context) {
              return ReligionType.getValues().map((ReligionType religionType) {
                return Text(
                  religionType.toString(),
                  style: GoogleFonts.roboto(
                    textStyle: Theme.of(context).textTheme.headline4,
                    fontSize: 13,
                    fontWeight: FontWeight.w700,
            ...
            items: ReligionType.getValues().map((ReligionType religionType) {
              return DropdownMenuItem<ReligionType>(
                value: religionType,
                child: Text(
                  religionType.toString(),
                  style: GoogleFonts.roboto(
