...
class ParadeStateViewModel extends MultipleFutureViewModel {
  ...
  void onEditStatus(String? value, String username) {
   ///Edit status input here


  }
  
  static const String _ParadeStateDelayedFuture = "paradeState";
  List<List<String>> get fetchedParadeState =>
      dataMap![_ParadeStateDelayedFuture];
  ...
  Future<List<List<String>>> getParadeState() async {
    ...
    for (int i = 0; i < _list.length; i++) {
      ...
      String _fullName =
          await db.singleDataPull("Users", "username", _localUser, "fullName");
